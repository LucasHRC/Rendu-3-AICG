      ...
      <div class="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <section class="bg-gray-50 rounded-lg p-4">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label class="block text-xs font-medium text-gray-600 mb-2">
                Vitesse TTS: <span id="tts-rate-value" class="text-indigo-600 font-bold">1.0</span>x
              </label>
              <input type="range" id="tts-rate-slider" min="0.5" max="2" step="0.1" value="1.0"
            ...
            <div>
              ...
              <input type="number" id="silence-delay" min="500" max="5000" step="100" value="2000"
